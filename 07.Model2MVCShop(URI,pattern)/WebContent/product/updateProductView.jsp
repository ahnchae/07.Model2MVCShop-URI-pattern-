...
function fncDeleteConfirm(message){
	if(confirm(message)){
		fncAddProduct('1');
	}else{
		return;
			...
			<table border="0" cellspacing="0" cellpadding="0">
				...
				<td width="17" height="23">
					...
					<td background="/images/ct_btnbg02.gif" class="ct_btn01"	style="padding-top: 3px;">
						<a href="javascript:fncDeleteConfirm('정말 삭제하시겠습니까? \n삭제된 상품은 복구할 수 없습니다.')">상품 삭제</a>
						<%--<a href="/deleteProduct.do?prod_no=${product.prodNo}">상품 삭제</a> --%>
					</td>
